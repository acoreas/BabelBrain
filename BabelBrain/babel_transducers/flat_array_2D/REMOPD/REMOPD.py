...
from babel_transducers.transducer_templates import flat_array_2D_tx
from CalculateFieldProcess import CalculateFieldProcess
from GUIComponents.ScrollBars import ScrollBars as WidgetScrollBars
from Utils.paths import resource_path


class REMOPD(flat_array_2D_tx.FlatArray2DTx): 
...
class RunAcousticSim(flat_array_2D_tx.RunAcousticSim):
